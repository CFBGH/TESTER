...
class Paths
{
	...
	/*static public function replay(key:String, ?library:String):Any
	{
		var replay: = ('sounds', key, library);
		return replay;
	}*/
	...
	inline static public function langfile(key:String):String {
		return getTextFromFile('language/$key.json');
	}
